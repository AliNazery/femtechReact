...
const PageHeader: React.FC<PageHeaderProps> = ({
  ...
  description,
    ...
    return (
      <section className="section page-header relative overflow-hidden pt-[60px] md:pt-[100px] pb-96  dark:bg-[z-40] after:z-10  after:absolute after:left-0 after:top-0  after:h-full after:w-full after:bg-quaternary/20 after:content-[''] after:clip-path-abtafter-polygon">
                ...
                >
                  <ol className="inline-flex" role="list">
                    <li
                      ...
                      role="listitem"
                    >
                      <Link className="text-pink align-middle " to="/">
                        Home
                      </Link>
                    </li>
                    <li
